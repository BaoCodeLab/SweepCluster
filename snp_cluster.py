...
def cluster(args):
    ...
    targetAnno_dic, targetOperon_dic = SNP_anno(vcf_file=vcf_file, anno_file=anno_file)
    ...
    cluster_out(clust_order, NewClust3Lg, targetClustRev_dic, NewClust2Lg, recomb_lg, out_file)
